...
canon.addCommand({
    name: "addNewlineAfter",
    exec: function(env, args, requests) { env.editor.addNewline(); }
});
canon.addCommand({
    name: "addNewlineBefore",
    exec: function(env, args, requests) { env.editor.addNewline(true); }
});
canon.addCommand({
    name: "gotoline",
...
canon.addCommand({
    name: "gotolinestartignorewhitespace",
    exec: function(env, args, request) { env.editor.navigateLineStart(true); }
});
canon.addCommand({
    name: "selectleft",
